...
function tmrd_menu_options() {
    ...
    $page = add_menu_page('TR Options', 'Webmaster', 'edit_theme_options', 'demo_options', 'tr_theme_options_callback');
...
function tr_settings_api_init() {
    ...
    add_settings_field('textarea_demo', 'Paste Html Meta Tag', 'tr_settings_field_demo_textarea', 'demo_options', 'general');
